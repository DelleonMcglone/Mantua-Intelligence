...
/**
 * Network gate. Mantua runs on **Arc Testnet only** — `MANTUA_NETWORK`
 * stays `testnet`. `IS_MAINNET` is retained (always false) so the few
 * launch-gated branches keep compiling until an Arc mainnet exists.
 */
