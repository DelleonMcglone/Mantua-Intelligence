...
| DM-111 | Agent wallet path          | **BLOCKED** — contingent on B8-001                                             | Cannot be decided before Arc support is verified; existing DCW path is the fallback and ships regardless                       |
