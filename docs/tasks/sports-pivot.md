...
| B7-003 | Swap handles market outcome tokens and base tokens (USDC / EURC / cirBTC) — ✅ COMPLETE — buy AND sell live in the sidebar (Buy/Sell tabs, holdings display with Max); positions offer one-click Close | 🔴 P0    | ⏸      |
