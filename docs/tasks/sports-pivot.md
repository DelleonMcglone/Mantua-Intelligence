...
| B3-006 | Market generator: new scheduled game auto-creates its market set per DM-106 — ✅ planner is pure and deterministic; two markets per game (one per side); on-chain creation gated on B2-005 deploy                                 | 🔴 P0    | ✅     |
