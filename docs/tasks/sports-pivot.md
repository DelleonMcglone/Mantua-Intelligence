...
| B10-007 | Security sign-off — zero HIGH findings open, MEDIUM accepted in writing (`docs/security/sign-off.md`) — ⏸ `docs/security/sign-off.md` DRAFTED — 0 HIGH, 0 MEDIUM open; awaiting owner's written acceptance of L-01/L-02                                                                                                                                                              | 🔴 P0    | ⏸      |
