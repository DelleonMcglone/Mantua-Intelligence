...
| P6-008 | Action: Portfolio Summary — show agent wallet balances + tx history. **Surface placement open** (per P6-002 note): the design's chat grid uses "Fund Agent Wallet" as its 6th card instead of Portfolio, so this action needs a non-grid surface — likely a sub-step inside the Wallet card (P6-003) or a route off the main shell.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | ⬜     |
