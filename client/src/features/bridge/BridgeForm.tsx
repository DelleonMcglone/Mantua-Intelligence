...
/**
 * The bridge form body (amount + destination network + execute via Circle
 * CCTP from the USER's connected wallet). Chrome-free so it can live as the
 * "Bridge" venue inside the Swap panel; the standalone bridge card is gone.
 */
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        <div className="text-[11px] text-text-mute tracking-[0.08em] font-semibold">TO NETWORK</div>
